...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon armor_stand ~ ~ ~ {Invisible:1b, Marker:1b, NoGravity: 1b, Small:1b, Tags:["nature_aura.aura.getter"]}
execute as @e[type=armor_stand, tag=nature_aura.aura.getter] at @s run function boomber:teleportation_api/tp
