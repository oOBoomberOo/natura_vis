...
execute if score #na.aura.frame bb.variable matches 0 as @e[type=armor_stand, tag=nature_aura.aura.loading] at @s run function nature_aura:aura/update/aura
