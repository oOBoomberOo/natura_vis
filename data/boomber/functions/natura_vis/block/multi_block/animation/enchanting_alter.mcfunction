...
execute as @s[scores={bb.animation=52..}] run scoreboard players operation #bb.nv.aura.io.sub.input bb.variable = #bb.nv.cost.enchanting_alter bb.variable
execute as @s[scores={bb.animation=52..}] run function boomber:natura_vis/aura/io/subtract
